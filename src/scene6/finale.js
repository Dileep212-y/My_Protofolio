...
export class Finale {
  ...
  async load() {
    const [plate, man, grain] = await Promise.all([
      loadImage('https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/fin/plate.jpg'),
      loadImage('https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/fin/man.png'),
