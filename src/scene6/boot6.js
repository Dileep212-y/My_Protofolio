...
export async function initFinale() {
  ...
  try {
    const meta = await fetch('https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/fin/fin.json').then((r) => r.json());
    fin.manBox = meta.man;
  ...
  if (frame2 && frame2Img) {
    ...
    const candidates = [
      ...
      'https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/fin/frame2.jpg',
