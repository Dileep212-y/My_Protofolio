...
const MEDIA = 'https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/media/';
...
async function main() {
  ...
  await Promise.all([
    ...
    app.stage.loadTextures({
      grunge: 'https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/tex/grunge.png',
      grain: 'https://raw.githubusercontent.com/gireeshkumarreddy/cinematic-portofilo/main/public/tex/grain.png',
    }).then(tick),
  ]);
